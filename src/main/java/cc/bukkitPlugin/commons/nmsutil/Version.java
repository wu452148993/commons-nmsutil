...
public enum Version {
	...
	public Boolean isNewerOrSame(Version version) {
		return this.versionInteger >= version.versionInteger || this.versionInteger == -2;
	}
	...
	public Boolean isOlderOrSame(Version version) {
		return this.versionInteger <= version.versionInteger || this.versionInteger == -1;
	}
	...
	public boolean inRange(Version oldVersion, Version newVersion) {
		return isNewer(oldVersion) && isOlder(newVersion);
	}
	
	public boolean inRangeOrSame(Version oldVersion, Version newVersion) {
		return isNewerOrSame(oldVersion) && isOlderOrSame(newVersion);
	}
}